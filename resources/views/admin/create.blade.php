                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="number" name="harga_awal" class="form-control @error('harga_awal') is-invalid @enderror" id="harga_awal" placeholder="Harga Awal" value="{{ old('harga_awal') }}" required>
                      @error('harga_awal')
                      <span class="invalid-feedback text-danger">{{ $message }}</span>
                      @enderror
                    </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="date" name="tanggal_akhir" class="form-control @error('tanggal_akhir') is-invalid @enderror" id="tanggal_akhir" value="{{ old('tanggal_akhir') }}" required>
                      @error('tanggal_akhir')
                      <span class="invalid-feedback text-danger">{{ $message }}</span>
                      @enderror
                    </div>
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="form-group">
                      ...
                      <input type="file" name="gambar" class="form-control @error('gambar') is-invalid @enderror" id="gambar" required accept="image/*">
                      @error('gambar')
                      <span class="invalid-feedback text-danger">{{ $message }}</span>
                      @enderror
                    </div>
